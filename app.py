...
file_path = "C:/Users/fpt/Documents/insurances.csv"
...
X = insurance_encoded[['age', 'bmi', 'sex_male', 'smoker_yes', 'region_northwest', 'region_southeast', 'region_southwest']]
...
def index():
    ...
    if request.method == 'POST':
        ...
        input_data['sex_male'] = 0  # Assuming the default is female
        ...
        # Tính RMSE và R^2 (có thể không cần thiết, nhưng để hiển thị)
        rmse = "Chưa tính toán"  # Bạn có thể tính toán nếu cần
        r2 = "Chưa tính toán"    # Bạn có thể tính toán nếu cần

    return render_template('giaodien.html', prediction=prediction, rmse=rmse, r2=r2)
